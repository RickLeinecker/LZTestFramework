...
char *LZW::genOutName(bool compress)
{
    char *outputFileName; 
    int i = 0;
...
// the symbol table.
bool LZW::processByte(char byte, bool cScSc)
{
...
void LZW::processSymbol(unsigned int symbol)
{
...
bool LZW::addToTable(string wrkStr, char singleByte)
{
...
void LZW::pushToCompStream(unsigned int symbol, int symbolBits)
{
...
void LZW::processDecompStream(char readByte, ofstream &outputFile)
{
